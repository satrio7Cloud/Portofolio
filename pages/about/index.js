    ...
    info: [
      {
        ...
        stage: 'change in the world of technology by developing innovative solutions that solve real problems.',
      },
      {
        title: 'Building Quality Products:',
        stage: 'Mention high-quality products and services that help clients achieve their goals.',
      },
    ],
  },
];
      ...
      <div className='container mx-auto h-full flex flex-col items-center xl:flex-row gap-x-6'>
        ...
        <div className='flex-1 flex flex-col justify-center'>
          ...
          <motion.p  variants={fadeIn('right', 0.4)} 
            ...
            >
              Hello, I'm Satrio, a Full Stack Developer with a great passion for creating innovative and high-quality web solutions. 
              I am very passionate about exploring the world of technology and continuing to learn to keep up with 
